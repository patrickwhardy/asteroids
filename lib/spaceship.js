...
SpaceShip.prototype.draw = function() {
  ...
  this.context.lineTo(this.starboard.x, this.starboard.y)
  this.context.lineTo(this.port.x, this.port.y)
...
SpaceShip.prototype.findSides = function() {
  this.starboard = {x: (this.x + Math.cos(this.orientation + 0.3) * 20.6155), y: (this.y - Math.sin(this.orientation + 0.3) * 20.6155) }
  this.port = {x: (this.x + Math.cos(this.orientation - 0.3) * 20.6155), y: (this.y - Math.sin(this.orientation - 0.3) * 20.6155) }
}
