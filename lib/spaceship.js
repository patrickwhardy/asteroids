...
SpaceShip.prototype.thrusters = function() {
  ...
  this.context.lineTo(this.rightSide.x + Math.cos(this.orientation), this.rightSide.y - Math.sin(this.orientation))
  this.context.lineTo(this.leftSide.x + Math.cos(this.orientation), this.leftSide.y - Math.sin(this.orientation))
  this.context.closePath();
