...
Game.prototype.update = function(asteroid) {
  this.checkTime();
...
// Game.prototype.checkBulletToShipCollison() {
//
// }
...
Game.prototype.endGame = function() {
  ...
  this.context.fillText("Alien Ships Destroyed: " + this.aliensDestroyed, 350, 310)
  this.context.fillText("Score: " + this.score, 350, 350)
  this.gameOver = true
}
