...
Game.prototype.clearBullets = function() {
  if (this.alienBullets.length > 100) {
    this.alienBullets.splice(49, 50)
  }
}
...
Game.prototype.enemyBullets = function() {
  var thisGame = this
  this.alienShips.forEach(function(alien) {
    alien.bullets.forEach(function(bullet){
      thisGame.alienBullets.push(bullet)
    })
  })
}
...
Game.prototype.checkBulletCollision = function() {
  ...
  // var enemyBullets = this.alienShips.map(function(alien){
  //   alien.bullets
  // })
  // debugger;
  this.ship.bullets.forEach(function(bullet) {
